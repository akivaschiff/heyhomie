...
server.tool("list_calendars", "List all calendars available to this assistant. Returns the user's configured calendar.", {}, async () => {
...
server.tool("list_events", "List events from the user's calendar. If no calendarId is specified, uses the user's primary calendar.", {
