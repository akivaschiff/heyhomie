...
server.tool(
  "set_volume",
  "Set the audio output volume. Use this when the user asks to change, increase, decrease, or mute the volume.",
  {
...
server.tool(
  "get_volume",
  "Get the current audio output volume level. Use this when the user asks what the current volume is.",
  {},
  async () => {
    try {
...
server.tool(
  "update_and_reboot",
  "Update Homie from git and reboot the system. Use this when the user asks to update, upgrade, or get the latest version of Homie.",
  {},
  async () => {
    try {
